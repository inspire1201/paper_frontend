...
const CategorySearch = React.lazy(() => import('./Pages/InArea/CategorySearch'))
const BySurname = React.lazy(() => import('./Pages/searchArea/BySurname'))
const ByCaste = React.lazy(() => import('./Pages/searchArea/ByCaste'))
const ByCategory = React.lazy(() => import('./Pages/searchArea/ByCategory'))
...
const routes = [
  ...
  { path: '/category-search', name: 'Category Search', element: CategorySearch },
  { path: '/in-area/by-surname', name: 'By Surname', element: BySurname },
  { path: '/in-area/by-caste', name: 'By Caste', element: ByCaste },
  { path: '/in-area/by-category', name: 'By Category', element: ByCategory },
